...
#define CY_CAPSENSE_SM_REG_CTL_FLD_ENABLED                                  (0x1uL)
...
#define CY_CAPSENSE_SM_REG_SCAN_CTL2_FLD_NUM_EPI_KREF_DELAY                 (0x2uL)
...
#define CY_CAPSENSE_SM_REG_INIT_CTL1_FLD_NUM_INIT_CMOD_12_RAIL_CYCLES       (0xc8uL)
#define CY_CAPSENSE_SM_REG_INIT_CTL1_FLD_NUM_INIT_CMOD_12_SHORT_CYCLES      (0xc8uL)
#define CY_CAPSENSE_SM_REG_INIT_CTL1_FLD_PER_SAMPLE                         (0x0uL)

/* INIT_CTL3: Initialization Control 3 */
#define CY_CAPSENSE_SM_REG_INIT_CTL3_FLD_NUM_PRO_OFFSET_CYCLES              (0x0uL)
...
#define CY_CAPSENSE_SM_REG_INIT_CTL4_FLD_NUM_PRO_DUMMY_SUB_CONVS            (0x3uL)
#define CY_CAPSENSE_SM_REG_INIT_CTL4_FLD_NUM_PRO_WAIT_KREF_DELAY_PRS        (0x0uL)
#define CY_CAPSENSE_SM_REG_INIT_CTL4_FLD_NUM_PRO_WAIT_KREF_DELAY            (0x2uL)
...
#define CY_CAPSENSE_SM_REG_CCOMP_CDAC_CTL_FLD_SEL_CO_PRO_OFFSET             (0x0uL)
...
#define CY_CAPSENSE_SM_REG_PUMP_CTL_FLD_PUMP_MODE                           (0x1uL)

/* IMO_CTL: Local MRSS IMO Control */
#define CY_CAPSENSE_SM_REG_IMO_CTL_FLD_FREQ                                 (0x6uL)
...
#define CY_CAPSENSE_SM_REG_MRSS_CMD_FLD_MRSS_START                          (0x1uL)
...
* * MODE0: CSD RM
* * MODE1: CSX RM
* * MODE2: ISX 2 pin Flyback Ext VDDA/2
* * MODE3: CSD RM with CapDAC dithering
* * MODE4: CSX RM with CapDAC dithering
* * MODE5: ISX RM with CapDAC dithering
...
#define CY_CAPSENSE_SM_REG_MODE2_SW_SEL_CMOD1_FLD_SW_AMUXA                  (0x3uL)
...
#define CY_CAPSENSE_SM_REG_MODE2_SW_SEL_CMOD2_FLD_SW_AMUXA                  (0x4uL)
#define CY_CAPSENSE_SM_REG_MODE2_SW_SEL_CMOD2_FLD_SW_AMUXB                  (0x0uL)
...
#define CY_CAPSENSE_SM_REG_MODE5_SW_SEL_CMOD1_FLD_SW_AMUXA                  (0x3uL)
...
#define CY_CAPSENSE_SM_REG_MODE5_SW_SEL_CMOD2_FLD_SW_AMUXA                  (0x4uL)
#define CY_CAPSENSE_SM_REG_MODE5_SW_SEL_CMOD2_FLD_SW_AMUXB                  (0x0uL)
...
/*********** SW_SEL_CSW_FUNC7: ISX RX *************/
#define CY_CAPSENSE_SM_REG_SW_SEL_CSW_FUNC7_FLD_SW_AMUXA                    (0xAuL)
#define CY_CAPSENSE_SM_REG_SW_SEL_CSW_FUNC7_FLD_SW_AMUXB                    (0x0uL)

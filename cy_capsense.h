...
/**
********************************************************************************
* \mainpage CapSense Middleware Library
********************************************************************************
*
* Alpha Release - The support for the PSoC 4100S Max family on ModusToolbox is currently at the Alpha level.
* Features may change without notice.
* Contact <a href="https://www.cypress.com/support"><b>Cypress Support</b></a> for additional details.
*
...
*
* \note This documentation includes only the new version to support fifth CapSense
* generation devices with MSCv3 HW blocks. For detail, contact Cypress support team.
*
********************************************************************************
...
********************************************************************************
*
* CapSense operates on the top of the CapSense MSC (Multi-Sensor Convertor) driver.
